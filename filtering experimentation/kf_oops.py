...
class PoseEstimator:
    ...
    # Plot variances for the last 90 frames for all keypoints
            ...
            plt.legend(
                ...
                title='Keypoints'
            )  # Adjust legend position and add title
            plt.tight_layout()  # Prevent clipping of legend or title
            plt.show()
        ...
        result_person = self.person_model.predict(img, verbose=False)
        pose_results = None
...
def parse_arguments():
    ...
    parser.add_argument('--video-path', type=str, 
                        default="/home/cha0s/D04_G1_S1 (trimmed).mp4", 
                        help='Video path')
