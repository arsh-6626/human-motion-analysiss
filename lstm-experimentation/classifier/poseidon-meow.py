...
# Create the Poseidon model
model = Poseidon(cfg, device=device, phase='train').to(device)

# Print the model summary
summary(model, input_size=(1, cfg.WINDOWS_SIZE, 3, 256, 192))  # Example input shape
